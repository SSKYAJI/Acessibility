...
class C3(nn.Module):
    """Implements a CSP Bottleneck Model with three convolutions for enhanced feature extraction in neural networks."""

    def __init__(self, c1, c2, n=1, shortcut=True, g=1, e=0.5):
        """Initializes C3 Model with options for channel count, bottleneck repetition, shortcut usage, group
...
class C3x(C3):
    """Extends the C3 Model with cross-convolutions for enhanced feature extraction in neural networks."""

    def __init__(self, c1, c2, n=1, shortcut=True, g=1, e=0.5):
        """Initializes C3x Model with cross-convolutions, extending C3 with customizable channel dimensions, groups,
        and expansion.
        """
...
class C3TR(C3):
    """C3 Model with TransformerBlock for enhanced feature extraction in object detection models."""

    def __init__(self, c1, c2, n=1, shortcut=True, g=1, e=0.5):
        """Initializes C3 Model with TransformerBlock for enhanced feature extraction, accepts channel sizes, shortcut
...
class C3SPP(C3):
    """Extends the C3 Model with an SPP layer for enhanced spatial feature extraction and customizable channels."""

    def __init__(self, c1, c2, k=(5, 9, 13), n=1, shortcut=True, g=1, e=0.5):
        """Initializes a C3 Model with SPP layer for advanced spatial feature extraction, given channel sizes, kernel
...
class C3Ghost(C3):
    """Implements a C3 Model with Ghost Bottlenecks for efficient feature extraction in YOLOv5."""

    def __init__(self, c1, c2, n=1, shortcut=True, g=1, e=0.5):
        """Initializes YOLOv5's C3 Model with Ghost Bottlenecks for efficient feature extraction."""
        super().__init__(c1, c2, n, shortcut, g, e)
        c_ = int(c2 * e)  # hidden channels
...
class Focus(nn.Module):
    ...
    def __init__(self, c1, c2, k=1, s=1, p=None, g=1, act=True):
        """Initializes Focus Model to concentrate width-height info into channel space with configurable convolution
        parameters.
        """
        super().__init__()
...
class Expand(nn.Module):
    ...
    def __init__(self, gain=2):
        """
        Initializes the Expand Model to increase spatial dimensions by redistributing channels, with an optional gain
        factor.
...
class Concat(nn.Module):
    ...
    def __init__(self, dimension=1):
        """Initializes a Concat Model to concatenate tensors along a specified dimension."""
        super().__init__()
        self.d = dimension
...
class DetectMultiBackend(nn.Module):
    ...
    def __init__(self, weights="yolov5s.pt", device=torch.device("cpu"), dnn=False, data=None, fp16=False, fuse=True):
        ...
        if pt:  # PyTorch
            ...
            names = model.module.names if hasattr(model, "Model") else model.names  # get class names
...
class Proto(nn.Module):
    """YOLOv5 mask Proto Model for segmentation models, performing convolutions and upsampling on input tensors."""

    def __init__(self, c1, c_=256, c2=32):
        """Initializes YOLOv5 Proto Model for segmentation with input, proto, and mask channels configuration."""
        super().__init__()
