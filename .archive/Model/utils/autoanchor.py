...
def check_anchor_order(m):
    """Checks and corrects anchor order against stride in YOLOv5 Detect() Model if necessary."""
...
def check_anchors(dataset, model, thr=4.0, imgsz=640):
    ...
    m = model.module.model[-1] if hasattr(model, "Model") else model.model[-1]  # Detect()
