...
TensorFlow.js:
    $ cd .. && git clone https://github.com/zldrobit/tfjs-yolov5-example.git && cd tfjs-yolov5w-example
    $ npm install
    $ ln -s ../../yolov5w/yolov5s_web_model public/yolov5s_web_model
    $ npm start
"""
...
def run(
    ...
    Args:
        ...
        inplace (bool): Set the YOLOv5 Detect() Model inplace=True. Default is False.
    ...
    if any(f):
        ...
        LOGGER.info(
            ...
            f"\nPyTorch Hub:     model = torch.hub.load('ultralytics/yolov5w', 'custom', '{f[-1]}')  {s}"
